<footer class="bg-gray-900 border-t border-gray-800">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-1">
                <div class="flex items-center">
                    ...
                    <span class="ml-2 text-white font-bold text-xl">ShopName</span>
                </div>
            ...
            <div class="col-span-1">
                <h3 class="text-sm font-semibold text-white tracking-wider uppercase">Shop</h3>
                <ul class="mt-4 space-y-2">
                    ...
                    <li><a href="#" class="text-gray-400 hover:text-white text-sm">All Products</a></li>
                </ul>
            </div>
            ...
            <div class="col-span-1 md:col-span-1">
                ...
                <p class="mt-4 text-sm text-gray-400">Get the latest updates, news and product offers.</p>
                <form class="mt-4">
                    <div class="flex">
                        <input type="email" name="email" id="email" required placeholder="Your email address" class="min-w-0 flex-1 bg-gray-800 border border-gray-700 rounded-l-md px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        <button type="submit" class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-r-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Subscribe
                        </button>
                    </div>
                </form>
        ...
        <div class="mt-12 border-t border-gray-800 pt-8">
            <p class="text-sm text-gray-400 text-center">&copy; {{ date('Y') }} ShopName. All rights reserved.</p>
        </div>
    </div>
</footer>
